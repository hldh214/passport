...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_App__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes__ = __webpack_require__(41);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    methods: {
        ...
        logout: function logout() {
            ...
            axios.get('/api/auth/student/logout').then(function (_) {
                localStorage.removeItem('access_token');
                _this.$router.go(0);
            });
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Welcome__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_PageNotFound__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_PageNotFound___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_PageNotFound__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Login__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Signup__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Signup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Signup__);





var routes = [{ path: '/', name: 'welcome', component: __WEBPACK_IMPORTED_MODULE_0__components_Welcome___default.a, meta: { requiresAuth: false } }, { path: '/login', name: 'login', component: __WEBPACK_IMPORTED_MODULE_2__components_Login___default.a }, { path: '/signup', name: 'signup', component: __WEBPACK_IMPORTED_MODULE_3__components_Signup___default.a }, { path: "*", component: __WEBPACK_IMPORTED_MODULE_1__components_PageNotFound___default.a }];
...
/* scopeId */
var __vue_scopeId__ = "data-v-410d367b"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
var update = __webpack_require__(3)("54732f12", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUser: function getUser() {
            ...
            axios.get('/api/student/profile').then(function (response) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("51fa9e47", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f553a56\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PageNotFound.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f553a56\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PageNotFound.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("a10eaa9a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.inputText.email,
                expression: "inputText.email"
              }
            ],
            attrs: { id: "email", type: "email", name: "email" },
            domProps: { value: _vm.inputText.email },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.inputText, "email", $event.target.value)
              }
            }
          })
        ]),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.inputText.password,
                expression: "inputText.password"
              }
            ],
            attrs: { id: "password", type: "password", name: "password" },
            domProps: { value: _vm.inputText.password },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.inputText, "password", $event.target.value)
              }
            }
          })
        ]),
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-ee7a8be2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ee7a8be2", Component.options)
  } else {
    hotAPI.reload("data-v-ee7a8be2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7377eabb", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ee7a8be2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Signup.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ee7a8be2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Signup.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
      ...
      [
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.inputText.name,
                expression: "inputText.name"
              }
            ],
            attrs: { id: "name", type: "text", name: "name" },
            domProps: { value: _vm.inputText.name },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.inputText, "name", $event.target.value)
              }
            }
          })
        ]),
        ...
        _c("label", { attrs: { for: "password_confirmation" } }, [
          ...
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.inputText.password_confirmation,
                expression: "inputText.password_confirmation"
              }
            ],
            attrs: {
            ...
            domProps: { value: _vm.inputText.password_confirmation },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ee7a8be2", module.exports)
  }
}
